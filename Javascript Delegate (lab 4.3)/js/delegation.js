function getTarget(e) {                          // Declare function
  ...
  function itemDone(e) {                           // Declare function
    ...
    if ( target.nodeName.toLowerCase() == "a" ) {  // If user clicked on an a element // vi nodename luc nao cung duoc in hoa nen phai co toLowerCase()
    ...
    if ( target.nodeName.toLowerCase() == "em" ) { // If the user clicked on an em element // vi neu chi target nodename == "a" thi kkhi click vao chu fresh se khong the xoa di element nen ta phai them dieu kien nay
